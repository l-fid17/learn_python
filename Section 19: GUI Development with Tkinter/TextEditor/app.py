...
def show_about_info():
    messagebox.showinfo(
        title="About",
        message="Simple Text Editor powered by Tkinter"
    )
...
def create_file(content="", title="Untitled"):
    ...
    text_scroll_y = ttk.Scrollbar(container, orient="vertical", command=text_area.yview)
    text_scroll_y.pack(side="right", fill="y")
    text_area["yscrollcommand"] = text_scroll_y.set
...
file_menu.add_command(label="Close Tab", command=close_current_tab, accelerator="Ctrl+Shift+Q")
...
root.bind("<Control-Shift-KeyPress-Q>", lambda event: close_current_tab())
